...
$route['sign-in/reset-password/(:any)'] = "signin/do_confirm_reset_password/$1";
$route['sign-in/reset-password'] = "signin/reset_password";
$route['sign-in/do-reset-password'] = "signin/do_send_reset_password";
...
$route['license/(:any)/do_deactivate_all'] = "services/do_deactivate_all/$1";
