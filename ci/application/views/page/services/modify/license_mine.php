                                    ...
                                    {foreach from=$packages key=package_id item=package}
                                        ...
                                        {$shown_addon_ids[]=$addon_id}
                                            <div class="row package_addon package_{$package_id} package_addon_{$addon_id}">
                                                ...
                                                <div class="{if $addon_id == 213}small-6{else}small-7{/if} columns label-save active field mc col-sm-4"><em>{$addon->description}</em>
                                                </div>
                                            </div>
                                        {/if}
                                        {/foreach}
