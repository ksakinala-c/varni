                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group"><label class="col-sm-2 control-label">Select</label>
                                <div class="col-sm-10">
                                    <select class="form-control m-b" data-original-package="{$service->package_id}" data-dropdown-options='{literal}{"cover":"false"}{/literal}' name="package">
                            ...
                            {foreach from=$packages key=package_id item=package}
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">{$addon->name}</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" id="package_addon_{$addon_id}"
                                                    ...
                                                    value="{if isset($service->configoptions[$addon->configopt_id])}{if $addon_id == 213}{$service->configoptions[$addon->configopt_id]->value+1}{else}{$service->configoptions[$addon->configopt_id]->value}{/if}{else}{if $addon_id == 213}1{else}0{/if}{/if}"><em>{$addon->description}</em>
