...
(function(e,t,n){"use strict";e.fn.foundationButtons=function(t){var r=e(document),i=e.extend({dropdownAsToggle:!0,activeClass:"active"},t),s=function(t){e(".cogbtn.dropdown").find("ul").not(t).removeClass("show-dropdown")},o=function(t){var n=e(".cogbtn.dropdown").not(t);n.add(e("> span."+i.activeClass,n)).removeClass(i.activeClass)};r.on("click.fndtn",".button.disabled",function(e){e.preventDefault()}),e(".cogbtn.dropdown > ul",this).addClass("no-hover"),r.on("click.fndtn",".cogbtn.dropdown:not(.split), .cogbtn.dropdown.split span",function(t){var n=e(this),r=n.closest(".cogbtn.dropdown"),u=e("> ul",r);t.target.nodeName!=="A"&&t.preventDefault(),s(i.dropdownAsToggle?u:""),u.toggleClass("show-dropdown"),i.dropdownAsToggle&&(o(r),n.toggleClass(i.activeClass))}),r.on("click.fndtn","body, html",function(t){if(n==t.originalEvent)return;e(t.originalEvent.target).is(".cogbtn.dropdown:not(.split), .cogbtn.dropdown.split span")||(s(),i.dropdownAsToggle&&o())});var u=e(".cogbtn.dropdown:not(.large):not(.small):not(.tiny)",this).outerHeight()-1,a=e(".button.large.dropdown",this).outerHeight()-1,f=e(".button.small.dropdown",this).outerHeight()-1,l=e(".button.tiny.dropdown",this).outerHeight()-1;e(".cogbtn.dropdown:not(.large):not(.small):not(.tiny) > ul",this).css("top",u),e(".cogbtn.dropdown.large > ul",this).css("top",a),e(".cogbtn.dropdown.small > ul",this).css("top",f),e(".cogbtn.dropdown.tiny > ul",this).css("top",l),e(".cogbtn.dropdown.up:not(.large):not(.small):not(.tiny) > ul",this).css("top","auto").css("bottom",u-2),e(".cogbtn.dropdown.up.large > ul",this).css("top","auto").css("bottom",a-2),e(".cogbtn.dropdown.up.small > ul",this).css("top","auto").css("bottom",f-2),e(".cogbtn.dropdown.up.tiny > ul",this).css("top","auto").css("bottom",l-2)}})(jQuery,this);
