...
if ( ! function_exists('set_cookie'))
{
    ...
    function set_cookie($name, $value = '', $expire = NULL, $path = NULL, $domain = NULL, $prefix = NULL, $secure = NULL, $httponly = NULL)
    {
        ...
        $name =  ($prefix === NULL ? config_item('cookie_prefix') : $prefix) . $name;
        ...
        {
            if (substr($headers[$i], 0, 11) != 'Set-Cookie:') {
                continue;
            }
            $value = trim(substr($headers[$i], 11));
            list($cookie_name, $value) = explode('=', $value, 2);
