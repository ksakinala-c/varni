...
# Don't make any changes here, they will be lost.  This file is overwritten
# in development and production staging environments.
...
$config['parser.smarty.cache_dir'] = APPPATH ."cache/smarty/cached";
