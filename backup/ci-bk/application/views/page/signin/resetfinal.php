        ...
        <div class="small-6 small-centered columns box-content">
          ...
          <div class="row">
            <div class="small-11 small-centered columns lgform">
              ...
              <h3>To complete your password recovery please enter your existing contact email address below.</h3>
              ...
              <div class="row">
                <div class="small-12 columns blabel">
                  ...
                  <input type="submit" class="tiny radius small-12 button" value="Complete password recovery" />
                </div>
              </div>
  ...
  <div class="push"></div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        if ($('#identifier').val() == "") { $('#identifier').focus(); } else if ($('#password').val() == "") { $('#password').focus(); } else { $('#confirm').focus(); }
        $('.shake-error').shake();
      });
    </script>
  </body>
